<template>
  <div class="app-container">
    ...
    <el-table ref="topictable" v-loading="loading" :height="tableHeight" :row-style="rowStyle" size="mini" border :data="tableData" @selection-change="selectionChangeHandle">
      ...
      <el-table-column prop="cameraId" label="ID" width="60" sortable align="center" />
  ...
  methods: {
    ...
    addOrUpdateHandle(flag) {
      ...
      if (flag !== 1) {
        ...
        this.$nextTick(() => {
          this.$refs.addOrUpdate.init(this.listQuery.communityId, this.ids[0].cameraId)
        })
      } else {
        this.$nextTick(() => {
