        ...
        <el-col :span="24">
          <el-form-item label="小区" prop="communityId">
            <el-select v-model="dataForm.communityId" placeholder="请选择小区" filterable style="width: 100%">
              <el-option v-for="community in communityList" :key="community.communityId" :label="community.communityName" :value="community.communityId" />
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="9">
          <el-form-item label="人脸识别" style="margin: 0;">
...
<script>
import { communityList, add } from '@/api/sys/inOut'
export default {
  data() {
    return {
      visible: false,
