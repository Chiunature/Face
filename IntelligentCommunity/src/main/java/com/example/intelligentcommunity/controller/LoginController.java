...
import com.example.intelligentcommunity.form.LoginForm;
import com.example.intelligentcommunity.service.UserService;
import com.example.intelligentcommunity.util.JwtUtil;
...
public class LoginController {
    ...
    public Result captcha() {
        ...
        map.put("uuid", uuid);//随机生成
        map.put("code", code);//随机生成
        map.put("captcha", specCaptcha.toBase64());//随机生成
